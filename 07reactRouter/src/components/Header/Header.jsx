...
const Header = () => {
  return (
    <header className='shadow sticky z-50 top-0'>
        <nav className='bg-white border border-gray-200 px-4 lg:px-6 py-3'>
            <div className='flex flex-wrap justify-between items-center mx-auto max-w-7xl'>
                ...
                <div className='flex items-center lg:order-2'>
                    ...
                    rounded-lg text-sm px-4 lg:px-5 py-3 lg:py-2.5 mr-2 focus:outline-none"
                    >
                        Log in
                    </Link>
                    <Link
                        ...
                        focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 mr-2 focus:outline-none"
                    >
                        Get started
                    </Link>
                </div>
